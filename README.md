# logstash-output-influxdb_v2

复制隔壁v1的版本  https://github.com/logstash-plugins/logstash-output-influxdb/  
删除了influxdb 1.* 的部分参数，添加了2.*版本要得参数  
更改了写入方式 将数据写到influxbd 2.0以上的版本  
修改了一些时间的处理，删除了分钟和小时的时间维度  
主要为个人使用  
安装方式  
logstash-plugin  install logstash-output-influxdb_v2-0.2.5.gem   
# Note
